                ...
                <form id="email-login-form" class="space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" class="pl-10 w-full h-12 border border-gray-300 rounded focus:ring-2 focus:ring-primary focus:border-primary text-sm" placeholder="dushyant@gmail.com">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="password" class="pl-10 pr-10 w-full h-12 border border-gray-300 rounded focus:ring-2 focus:ring-primary focus:border-primary text-sm" placeholder="••••••••">
    ...
    document.getElementById('email-login-form').addEventListener('submit', async function (e) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                messageEl.textContent = data.errors || 'Login failed.';
